...
- Search [existing issues](https://github.com/craigh33/adk-go-kronk/issues) and pull requests for duplicates.
...
If you find a security vulnerability, please **do not** open a public issue. Use [GitHub Security Advisories](https://github.com/craigh33/adk-go-kronk/security/advisories) for this repository if available, or contact the maintainers privately with enough detail to reproduce and assess impact.
